...
func TestCompatibilityCheck(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			result := compatibilityCheck{}.Run(context.Background(), Environment{Commands: commands})
...
func (r *fakeCommandRunner) LookPath(string) (string, error) { return r.path, r.lookupErr }
func (r *fakeCommandRunner) Run(_ context.Context, _ string, args ...string) CommandOutput {
...
func compatibleEnvironment(commands CommandRunner) Environment {
	return Environment{
		Commands: commands,
